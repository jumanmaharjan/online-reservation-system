...
<div id="timg">
	...
	<img  src="image/img3 "alt="Naruto picture" style="width:1180px;height:350px;">
...
<form name="formstyle" id="form1" action="updateInfo.php" method="post">	
	  
<fieldset>
		
<legend id="legend">Picking Ticket update</legend>
...
<td><input type="submit" name="booking" value="update"></td>
