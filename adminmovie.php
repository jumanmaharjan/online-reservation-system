...
<form name="formstyle" id="form1" action="adminInfo.php" method="post" enctype="multipart/form-date">
<fieldset>
...
<td>Movie type:</td>
<td><center>
<input type="checkbox" name="movies[]"  value="English movies">English Movie
<input type="checkbox" name="movies[]"  value="Hindi movies">Hindi Movie
<input type="checkbox" name="movies[]"  value="Animation movies">Animation Movie
<input type="checkbox" name="movies[]"  value="Nepali movies">Nepali Movie
</center></td>
</tr>
Movie File:
